sap.ui.define([
	...
	"use strict";
	return Object.extend("pro.dimensys.pm.logsheet.model.BaseObject", {
		...
		copyFields: function (properties) {
			...
			for (var prop in from) {
				if (fields.find(function (field) {
					...
					var newPropName = formatter(prop) || prop;
					to[newPropName] = toString && !(from[prop] instanceof Date) ? from[prop].toString() : from[prop];
				}
			}
			return to;
		},
